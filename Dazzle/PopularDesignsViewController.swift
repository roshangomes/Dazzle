...
class PopularDesignsViewController: UIViewController,UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let designCell = cell as? DesignCollectionViewCell {
...
//    var designs = Datamodel.sampleDesigns // Use sample data from Datamodel
//
//        override func viewDidLoad() {
//            super.viewDidLoad()
//            
...
//
//    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
//        let padding: CGFloat = 10 // adjust for spacing
//        let cellWidth = (collectionView.bounds.width - padding * 3) / 2
//        return CGSize(width: cellWidth, height: cellWidth * 1.2) // Adjust height ratio as needed
//    }
//
//        func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
//            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "DesignCell", for: indexPath) as! DesignCollectionViewCell
//            cell.configureCell(with: designs[indexPath.item])
//            return cell
//        }
